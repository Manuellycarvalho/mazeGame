...
const Maze = () => {
  ...
  return (
    <div id="wrapper" style={{ margin: '0 auto' }}>
      <h1 id="heading" style={{ backgroundColor: '#3AA9C7', color: '#8A3274', width: '40%', margin: '10px auto' }}>Ache a saída</h1>
      <div id="maze">
        <p style={{ textAlign: 'center', marginBottom: '10px' }}>Encontre o caminho para sair do labirinto em 45 segundos!</p>
